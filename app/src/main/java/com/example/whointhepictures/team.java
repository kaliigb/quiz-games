...
public class team extends AppCompatActivity {
    int [] img={R.drawable.brazilian,R.drawable.france,R.drawable.germany,R.drawable.italy};
    String []name ={"brazilian","france","germany","italy"};
    ...
    public void pp(View view) {
        ...
        {
            Intent intent=new Intent(team.this,managers.class);
